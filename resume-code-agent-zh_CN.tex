...
博士期间已发表\textbf{6 篇一作顶会/顶刊论文}，另有\textbf{1 篇 EMNLP 2026 在投一作论文}。
...
\section{实习经历}
  \resumeSubHeadingListStart
    \resumeSubheading
      {蚂蚁集团}{杭州, 中国}
      {机器智能部门 -- 算法研究实习生}{2024.11 -- 2026.05}
      \resumeItemListStart
        \resumeItem{构建可信 RAG 与图数据库查询 agent 体系：主导完成 RAG 可信对齐 (ACL 2025)、RAG 测试时自适应 (ICASSP 2026)、知识库问答强化学习 KBQA-R1 (ICML 2026)、GAPD (EMNLP 2026 投稿) 等工作。}
